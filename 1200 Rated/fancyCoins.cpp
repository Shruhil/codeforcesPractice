...
void coderAnsh() {
    ...
    int takenFancy_1 = max(0, taken_1 - a1);
    int takenFancy_k = max(0, taken_k - ak);
    int left_1_reg = max(0, a1 - taken_1);

    int to_rep = min(left_1_reg / k, takenFancy_k);

    cout << takenFancy_1 + takenFancy_k - to_rep;
}
